...
class YOLOVideoDetector(QMainWindow):
    ...
    def update_count_labels(self, class_counts):
        ...
        self.D00_count_label.setText(f"D00 Count: {class_counts['D00']}")
        self.D10_count_label.setText(f"D40 Count: {class_counts['D10']}")
        self.D20_count_label.setText(f"D20 Count: {class_counts['D20']}")
        self.D44_count_label.setText(f"D44 Count: {class_counts['D44']}")
        self.D01_count_label.setText(f"D01 Count: {class_counts['D01']}")
        self.D11_count_label.setText(f"D11 Count: {class_counts['D11']}")
        self.D50_count_label.setText(f"D50 Count: {class_counts['D50']}")
        self.D43_count_label.setText(f"D43 Count: {class_counts['D43']}")
        self.D0w0_count_label.setText(f"D0w0 Count: {class_counts['D0w0']}")
